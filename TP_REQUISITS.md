...
- [x] Each subagent has a clear, single responsibility — six subagents, one role each (`src/agent/team.py`, `src/prompts/__init__.py`): the five required roles plus a **Scribe** (the only writer).
